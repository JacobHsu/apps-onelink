...
export const educationData: AppCategory = {
  n: "Language",
  d: "Education",
...
export const productivityData: AppCategory = {
  n: "Habit",
  d: "Productivity",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
...
export const newsData: AppCategory = {
  n: "Information",
  d: "News",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
...
export const aiData: AppCategory = {
  n: "AI",
  d: "Assistant",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
...
export const financeData: AppCategory = {
  n: "Crypto",
  d: "Finance",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
    ...
    },
    {
      ...
      url: "https://apps.apple.com/tw/app/maicoin-買賣比特幣/id1438144202",
    },
    {
      name: "Coinglass",
...
export const healthData: AppCategory = {
  n: "Fitness",
  d: "Health",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
...
export const toolsData: AppCategory = {
  n: "Tools",
  d: "Utilities",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
    ...
    {
      name: "VPN Pro - Fast Secure Proxy",
...
export const tvData: AppCategory = {
  n: "TV",
  d: "Entertainment",
  i: "https://www.apple.com/v/app-store/b/images/overview/icon_appstore__ev0z770zyxoy_large.png",
  apps: [
...
export const demoData: Record<string, AppCategory> = {
